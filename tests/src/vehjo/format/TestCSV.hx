package vehjo.format;

import haxe.io.Eof;
import haxe.io.StringInput;
import vehjo.format.csv.Reader;
import vehjo.format.csv.Writer;

class TestCSV extends vehjo.unit.TestCase {
	...
	static function main() {
		var x = new vehjo.unit.TestRunner();
		x.add( new TestCSV() );
		x.run();
	}
